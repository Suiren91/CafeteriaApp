...
class Orders
{
  public:
    ...
    const int32_t &getValueOfTotalPrice() const noexcept;
    ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
    const std::shared_ptr<int32_t> &getTotalPrice() const noexcept;
    ///Set the value of the column total_price
    void setTotalPrice(const int32_t &pTotalPrice) noexcept;
  ...
  private:
    ...
    std::shared_ptr<int32_t> totalPrice_;
